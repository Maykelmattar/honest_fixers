...
class Priority extends React.Component {
  ...
  changeStatus(e){
    ...
    axios({
      method: "post",
      url: `${DB_Link}priority_status.php`,
      data: JSON.stringify(_data),
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  addPriority=(e)=> {
    ...
    axios({
      method: "post",
      url: this.state.editing===0?`${DB_Link}priority_create.php`:`${DB_Link}priority_update.php`,
      data: JSON.stringify(_data),
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  render() {
    return (
     ...
     <MDBDataTable
          ...
          <MDBContainer>
          <form onSubmit={(e)=>{this.addPriority(e)}}>
      <MDBModal isOpen={this.state.modal}  size='lg' toggle={this.toggle} >
        <MDBModalHeader toggle={this.toggle}>Add New Priority</MDBModalHeader>
        <MDBModalBody>
        ...
        <MDBModalFooter>
        <button type="submit"  onClick={(e)=>{this.addPriority(e)}} className="login100-form-btn submitButn">
                                Submit
                            </button>
                                    </MDBModalFooter>
      </MDBModal>
